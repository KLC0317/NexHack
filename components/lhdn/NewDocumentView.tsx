...
export function NewDocumentView({ theme, onSubmit }: { theme: "light" | "dark", onSubmit?: (doc: LHDNDocument) => void }) {
  ...
  const steps = [
    ...
    { id: 2, name: "Supplier And Buyer" },
    { id: 3, name: "Line Item" },
    { id: 4, name: "Additional Information" },
    { id: 5, name: "Summary And Submit" },
  ];
    ...
    return (
      <div className="animate-in fade-in duration-300 max-w-4xl">
        <div className="flex items-center border-b border-[#edebe9] dark:border-[#3b3a39] mb-8 pb-4">
          ...
          <h1 className="text-xl font-medium">New Document</h1>
          <span className="mx-4 text-gray-300">|</span>
          <span className="text-sm text-gray-400">Or continue from:</span>
          <button className="text-sm text-[#3b43a8] font-medium ml-2 flex items-center">
            <FileText className="w-4 h-4 mr-1" /> Drafts
          </button>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
          <div>
            <label className="block text-sm font-medium mb-2 text-gray-700 dark:text-gray-300">Type of Document</label>
            <select 
            ...
            >
              ...
              <option>Refund Note</option>
            </select>
          </div>
          <div>
            <label className="block text-sm font-medium mb-2 text-gray-700 dark:text-gray-300">Document Version</label>
            <select 
  ...
  return (
    <div className="animate-in fade-in duration-300 max-w-5xl">
      ...
      <div className="flex items-start justify-between mb-6">
        <div>
          <h1 className="text-xl font-semibold">{docType} | {docVersion}</h1>
          <p className="text-sm text-gray-500 mt-1">e-Invoice Code / Number<br/>23701915219</p>
        </div>
        {renderStepper()}
      </div>
      ...
      <div className={`border rounded-lg shadow-sm ${theme === "dark" ? "bg-[#201f1e] border-[#3b3a39]" : "bg-white border-[#edebe9]"}`}>
        ...
        {step === 1 && (
          <div className="p-8">
            <h2 className="text-lg font-semibold border-b-2 border-[#292b45] inline-block pb-1 mb-8">Basic Information</h2>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-8">
              <div>
                <div className="flex justify-between items-center mb-2">
                  <label className="text-sm font-medium">e-Invoice Code / Number <span className="text-red-500">*</span></label>
                  <button className="text-xs text-[#3b43a8] flex items-center"><Edit2 className="w-3 h-3 mr-1" /> Override</button>
                </div>
              ...
              <div className="text-sm text-gray-500 self-center pt-6">
                e-Invoice Code / Number can be edited to align with your own organization. Or, it can be automatically generated.
              </div>

              <div>
                <div className="flex justify-between items-center mb-2">
                  <label className="text-sm font-medium">Date and Time Issued <span className="text-red-500">*</span></label>
                  <button className="text-xs text-[#3b43a8] flex items-center"><Edit2 className="w-3 h-3 mr-1" /> Override</button>
                </div>
              ...
              <div className="text-sm text-gray-500 self-center pt-6">
                Will be automatically generated upon submission, unless you need a specific date manually picked
              </div>

              <div>
                <label className="block text-sm font-medium mb-3">Notify me about this document</label>
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-sm">Personally on Web / Mobile</span>
                </div>
              </div>
              <div className="text-sm text-gray-500 self-center pt-6">
                By default you and taxpayer will receive only notifications as defined in <a href="#" className="text-[#3b43a8] underline">Taxpayer Preferences</a>
              </div>
            </div>
          </div>
        )}
        ...
        {step === 2 && (
          <div className="p-8">
            <h2 className="text-lg font-semibold border-b-2 border-[#292b45] inline-block pb-1 mb-8">Supplier And Buyer</h2>
            {/* The massive form from Image 5 */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
              ...
              <div>
                <label className="block text-sm font-medium mb-1">Registration / Identification / Passport Number</label>
              ...
              <div>
                <label className="block text-sm font-medium mb-1">MSIC Code <span className="text-red-500">*</span></label>
              ...
              <div>
                <label className="block text-sm font-medium mb-1">Business Activity Description <span className="text-red-500">*</span></label>
                <input type="text" defaultValue="Not Applicable" className={`w-full p-2.5 rounded border outline-none ${theme === "dark" ? "bg-[#323130] border-[#3b3a39]" : "bg-white border-[#edebe9]"}`} />
              </div>
              <div>
                <label className="block text-sm font-medium mb-1">SST Registration Number</label>
              ...
              <div className="md:col-span-2 my-4 border-t border-dashed border-gray-300 dark:border-gray-700 pt-4"><span className="text-sm font-semibold text-[#3b43a8]">Buyer Details</span></div>

              <div>
                <label className="block text-sm font-medium mb-1">ID Type <span className="text-red-500">*</span></label>
                <input type="text" defaultValue="Business Registration No." className={`w-full p-2.5 rounded border outline-none ${theme === "dark" ? "bg-[#323130] border-[#3b3a39]" : "bg-white border-[#edebe9]"}`} />
              </div>
              <div>
                <label className="block text-sm font-medium mb-1">Registration / Identification Number <span className="text-red-500">*</span></label>
              ...
              <div>
                <label className="block text-sm font-medium mb-1 flex items-center">Tax Identification Number (TIN) <span className="text-red-500 mx-1">*</span> <Info className="w-3 h-3 text-gray-400"/></label>
                <div className="flex space-x-2">
                  ...
                  <button onClick={() => setTin("")} className="bg-[#292b45] hover:bg-[#1a1c30] text-white px-4 rounded text-sm transition-colors">Clear</button>
                </div>
              </div>
              <div />
              ...
              <div>
                <label className="block text-sm font-medium mb-1">SST Registration Number <span className="text-red-500">*</span></label>
        ...
        {step === 3 && (
          <div className="p-8">
            <div className="flex items-center justify-between border-b pb-4 mb-6">
               <h2 className="text-lg font-semibold border-b-2 border-[#292b45] inline-block mb-[-18px]">Line Item</h2>
               <div className="flex items-center space-x-6 text-sm">
                 ...
                 <div className="flex items-center">
                   <span className="text-gray-500 mr-2">Exchange Rate</span>
                 ...
                 <button className="text-[#3b43a8] flex items-center hover:underline"><FileText className="w-4 h-4 mr-1"/> Full View</button>
                 <button className="text-[#3b43a8] flex items-center hover:underline"><Clock className="w-4 h-4 mr-1"/> Select Previous Items</button>
                 <button onClick={() => setLineItems([...lineItems, { id: Date.now(), code: "022-Others", desc: "New Item Service", qty: 1, measure: "E48", total: 100 }])} className="text-[#3b43a8] flex items-center hover:underline font-semibold"><Plus className="w-4 h-4 mr-1"/> Add Line</button>
               </div>
            </div>
            ...
            <table className="w-full text-sm text-left mb-8">
              <thead className="bg-[#292b45] text-white">
                <tr>
                  <th className="px-4 py-3 font-medium">Classification Codes</th>
                  <th className="px-4 py-3 font-medium">Description of Product or Service</th>
            ...
            <div className="flex justify-end">
              <div className="w-96 space-y-4">
                <div className="flex items-center justify-between text-sm">
                  <span className="flex items-center">Total Tax Amount <Info className="w-3 h-3 ml-1 text-gray-400"/></span>
                  <div className="flex items-center">
                ...
                <div className="flex items-center justify-between text-sm">
                  <span className="flex items-center">Total Net Amount</span>
                  <div className="flex items-center">
                    <span className="w-12 bg-gray-100 dark:bg-gray-800 text-center py-1.5 border dark:border-gray-700 rounded-l">RM</span>
        ...
        {step === 4 && (
          <div className="p-8">
             <h2 className="text-lg font-semibold border-b-2 border-[#292b45] inline-block pb-1 mb-8">Additional Information</h2>
             <p className="text-sm text-gray-500 mb-4">You can add optional attachments or references here.</p>
             <textarea className={`w-full p-4 rounded border outline-none h-32 ${theme === "dark" ? "bg-[#323130] border-[#3b3a39]" : "bg-white border-[#edebe9]"}`} placeholder="Notes or remarks..."></textarea>
          </div>
        )}
        ...
        {step === 5 && (
          <div className="p-8">
            <h2 className="text-lg font-semibold border-b-2 border-[#292b45] inline-block pb-1 mb-8">Summary</h2>
            
            <div className="grid grid-cols-2 gap-8 mb-8">
              <div>
                <p className="text-sm text-gray-500 mb-1">e-Invoice Code / Number</p>
                <p className="font-medium">23701915219</p>
              </div>
              <div>
                <p className="text-sm text-gray-500 mb-1">Date and Time Issued</p>
            ...
            <div className="grid grid-cols-2 gap-8 border border-gray-200 dark:border-[#3b3a39] rounded overflow-hidden">
              {/* Supplier Header */}
              <div className="bg-[#292b45] text-white p-3 font-semibold text-sm border-r border-[#3b3a39]">Supplier (From)</div>
              {/* Buyer Header */}
              <div className="bg-[#292b45] text-white p-3 font-semibold text-sm">Buyer (To)</div>
              ...
              <div className="p-4 space-y-4 border-r border-gray-200 dark:border-[#3b3a39] text-sm">
                <div className="grid grid-cols-2">
                  ...
                  <div>
                    <p className="text-gray-500 mb-1">Tax Identification Number (TIN)</p>
                    <p className="font-medium">IG228600000</p>
                  </div>
                </div>
                <div className="grid grid-cols-2">
                  <div>
                    <p className="text-gray-500 mb-1">MSIC Code</p>
                    <p className="font-medium">00000</p>
                  </div>
                  <div>
                    <p className="text-gray-500 mb-1">SST Registration Number</p>
              ...
              <div className="p-4 space-y-4 text-sm">
                <div className="grid grid-cols-2">
                  ...
                  <div>
                    <p className="text-gray-500 mb-1">Registration / Identification</p>
        ...
        <div className={`p-4 border-t flex justify-between items-center ${theme === "dark" ? "border-[#3b3a39] bg-[#1a1c30]" : "border-[#edebe9] bg-[#f5f5f5]"}`}>
          ...
          <div className="flex items-center space-x-3">
             <span className="text-[#107c41] text-xs font-medium flex items-center mr-4"><Check className="w-3 h-3 mr-1"/> Auto-saved 3 minute Ago</span>
             ...
             {step < 5 ? (
               ...
               <button 
                 ...
                 className="bg-[#292b45] hover:bg-[#1a1c30] text-white px-6 py-2 rounded text-sm transition-colors flex items-center"
               >
                 <Send className="w-4 h-4 mr-2" /> Sign & Submit Document
               </button>
             )}
          </div>
        </div>
